...

{
  ...
  printf '\nbenchmark_env=\n'
  env | sort | grep -E '^(VUS|MSG_COUNT|PAYLOAD_SIZE|PUBLISH_BATCHES|BATCH_INTERVAL_SECONDS|RAMP_UP_SECONDS|HOLD_SECONDS|RAMP_DOWN_SECONDS|PUBLISH_START_SECONDS|PUBLISH_MAX_DURATION_SECONDS|DRAIN_SECONDS|LATENCY_P95_THRESHOLD_MS)=' || true
