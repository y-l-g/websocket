...
require (
	...
	github.com/dunglas/frankenphp/caddy v1.11.2-0.20260126230219-ddb11c1f72f5
...
require (
	...
	github.com/dunglas/mercure v0.21.5 // indirect
	github.com/dunglas/mercure/caddy v0.21.5 // indirect
